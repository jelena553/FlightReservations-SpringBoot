...
<body class="news">
  ...
  <header>
    <div class="nav">
      ...
      <c:choose>
      <c:when test="${empty rezAktuelne }">
      	<p class="prazniLetoviPoruka">
      	Nemate aktuelnih rezervacija
      ...
      <c:otherwise>
       ...
       <ul class=>
          ...
          <li>   <table class="tabela2" cellspacing="0">
                 ...
                 <c:forEach items="${rezAktuelne }" var="r">

                 <tr>
                    <td>${r.let.linija.polaziste } </td>
                    <td>${r.let.linija.odrediste } </td>
     ...
     <div class="isprintaj">
     <a href="/Aero/izvjestaji/izvjestajAktuelneRezervacije" class="tekstIsprintaj">Isprintaj sve rezervacije </a>
   </div>
   </c:otherwise>
   </c:choose>
